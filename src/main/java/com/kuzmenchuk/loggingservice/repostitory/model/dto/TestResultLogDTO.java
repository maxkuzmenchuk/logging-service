...
@AllArgsConstructor
@NoArgsConstructor
public class TestResultLogDTO extends LogBaseDTO {
    private Long testID;

    @Builder(builderMethodName = "testResultLogDTOBuilder")
    public TestResultLogDTO(Long logID, OperationType operationType, EntityType entityType, Long updatingUserID,
